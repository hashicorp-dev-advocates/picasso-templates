...
# # speakers
# picasso generate \
#   -t hashitalks/speakers/speaker_two_speakers_long_name.hcl \
#   -o $OUTPUT_DIR/speakers/ \
#   --var color=$COLOR \
#   --var edition=$EDITION \
#   --var date="28 de julho de 2022" \
#   --var url=$URL \
#   --csv $INPUT_DIR/csv/speakers_two_speakers_long_name.csv \
#   --csv-var speaker
